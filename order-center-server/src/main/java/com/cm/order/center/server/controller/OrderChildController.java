...
public class OrderChildController{
	 ...
	 */
	@RequestMapping(path="/orderchild/search",method=RequestMethod.POST)
	@ApiOperation("订单出库管理--分页集合查询")
	...
	public ClientResponesBean<ResultFrontendVo> search(@RequestBody ClientRequestBean clientRequestBean) {
		...
		return orderChildService.search(clientRequestBean);
	}
	 ...
	 */
	@RequestMapping(path="/orderchild/add",method=RequestMethod.POST)
	@ApiOperation("订单出库管理--添加信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<String> add(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderChildService.add(clientRequestBean);
	}
	 ...
	 */
	@RequestMapping(path="/orderchild/edit",method=RequestMethod.POST)
	@ApiOperation("订单出库管理--修改信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<Integer> edit(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderChildService.edit(clientRequestBean);
	}
	 ...
	 */
	@RequestMapping(path="/orderchild/query",method=RequestMethod.POST)
	@ApiOperation("订单出库管理--根据主键查询信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<OtcOrderChildPo> query(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderChildService.query(clientRequestBean);
	}
	 ...
	 * @return ClientResponesBean<TucUserAccountPo>
	 */
	@RequestMapping(path="/orderchild/queryVo",method=RequestMethod.POST)
	@ApiOperation("订单出库管理--根据主键查询信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<OtcOrderChildVo> queryVo(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderChildService.queryVo(clientRequestBean);
	}
	 ...
	 * @return ClientResponesBean<Integer>
	 */
	@RequestMapping(path="/orderchild/del",method=RequestMethod.POST)
	@ApiOperation("订单出库管理--根据主键删除信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<Integer> del(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderChildService.del(clientRequestBean);
	}
	@RequestMapping(path="/orderchild/batchDel",method=RequestMethod.POST)
	@ApiOperation("订单出库管理--根据主键删除信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<Integer> batchDel(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderChildService.batchDel(clientRequestBean);
	}
