...
public class OrderController{
	...
	public ClientResponesBean<ResultFrontendVo> search(@RequestBody ClientRequestBean clientRequestBean) {
		...
		return orderService.search(clientRequestBean);
	}
	...
	@ApiOperation("会员订单管理--根据主键查询信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<OtcOrderPo> query(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderService.query(clientRequestBean);
	}
	 ...
	 * @return ClientResponesBean<TucUserAccountPo>
	 */
	@RequestMapping(path="/order/queryVo",method=RequestMethod.POST)
	@ApiOperation("会员订单管理--根据主键查询信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<OtcOrderVo> queryVo(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderService.queryVo(clientRequestBean);
	}
	 ...
	 * @return ClientResponesBean<Integer>
	 */
	@RequestMapping(path="/order/del",method=RequestMethod.POST)
	@ApiOperation("会员订单管理--根据主键删除信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<Integer> del(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderService.del(clientRequestBean);
	}
	@RequestMapping(path="/order/batchDel",method=RequestMethod.POST)
	@ApiOperation("会员订单管理--根据主键删除信息")
	@ApiImplicitParam(name = "clientRequestBean", value = "请求参数", dataType = "ClientRequestBean")
	public ClientResponesBean<Integer> batchDel(@RequestBody ClientRequestBean clientRequestBean) {
		
		return orderService.batchDel(clientRequestBean);
	}
